...
<html>
   ...
   <body>
   <div class="main" style="background-image: url('index1.jpg'); background-size: cover;   background-position: center;">

  <div class="navbar">
    <div class="logo">Customer Segmentation</div>
    <ul>
     <li><a href="../Dashboard.php">Dashboard</a></li>
     <li><a href="Data/customer.php">Customer Data</a></li>
    </ul>
  </div>
    <div class="container">
      <br />
